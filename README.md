...
'describe()' is like a master suite, or folder that contains multiple related tests. `it()` is the granular individual test declaration.

1. What is the point of `Test Driven Development`? What do you think about this approach?

TDD requires developers to be more 'outcome driven' than 'process driven'. By defining the desired outcomes via test-writing, and then writing code to meet those tests, development can be cleaner and more understandable in the larger context.

1. Mention three types of automated tests.

Unit testing, Snapshot testing, and Integration testing.
